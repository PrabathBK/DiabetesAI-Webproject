...
accuracy0=accuracy_score(y_test,model.predict(x_test))
...
st.write("Accuracy of the model is:", accuracy2)
...
def user_inputs():
  ...
  input_dict={"Pregnancies":preg,"Glucose":glu,"Blood Pressure":bp,"skin Thickness":sthick,"Insulin Level":ins,"BMI":bmi,"Diabetes Pedigree Function":dpf,"Age":age}
